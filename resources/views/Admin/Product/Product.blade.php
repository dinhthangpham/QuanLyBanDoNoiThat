...
@section('content_home')
    ...
    @section('content_dialog')
        <form id="form_product"  enctype="multipart/form-data">
            ...
            <div class="form-group" id="infor_product">
                <div class="form-group" id="infor_product_1">
                    ...
                    <br>
                    <img style="width: 100px; margin-top:10px;" src="/Admin/Image/no-image.jpg" class="img-product-demo" id="img-product-demo" alt="">
                    <div>
        ...
        <div id="form_detail_product">
                        ...
                        <div class="form-group">
                            <div  class="form-group" id="infor_product_detail_1">
                                ...
                                <div class="form-group">
                                  ...
                                  <img style="width: 100px; margin-top:10px;" src="/Admin/Image/no-image.jpg" class="img-product-demo" id="img-product-detail_1" alt="">
                                  <br>
                                  ...
                                  <div class="row">
                                    <div class="col-sm-6">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input type="number" name="original_cost_product" id="original_cost_product-1" class="form-control" value=0 >
                                      </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <!-- text input -->
                                        <div class="form-group">
                                          ...
                                          <input type="number"  name="discount_product" id="discount_product-1" class="form-control" value=0 >
                                        </div>
                                      </div>
                                    
                                  </div>
                                  <div><label for="usr">Amount</label>
                                    <input  type="number" name="amout_product" id="amout_product-1" value=0  class="form-control">
                                </div> 
                                <br>                                
                            </div>
                        </div>
            ...
            <div>
                <input style="margin:10px; float:right" type="button" value="Save"  id="saveProduct" class="btn btn-success" ></input>
                <input style="margin:10px; float:right" type="button" onclick="onClickPreInput()" class="btn btn-danger" value="Back">
            </div>
    ...
    resetAllForm();       
            ...
            $.ajax({
                ...
                success: function (data){
                    ...
                    $('#category_product option[value='+data[0].categoryID+']').attr('selected','selected');
                    $("#img-product-demo").attr("src",data[0].avatar);        
                    CKEDITOR.instances['desc_product'].setData(data[0].desc);
                    for(var i=0;i<data.length;i++){        
                        displayUpdateFormDetail(i+1,{!! json_encode($colors) !!},data[0].id_product,data[i].productDetailsID,data[i].color_id,data[i].productDetailsImage,data[i].original_cost,data[i].discount,data[i].amount)
                        stt=i+1;
...
function displayUpdateFormDetail(stt,arrayColor,idProduct,idProductDetail,colorCategory,image,original_cost,discount,amount){
    let html="";
    if(stt==1)
    html += "<div class='div_product_detail  div_product_detail_"+stt+"'><div style='border-top: 2px solid #ff0000;'></div><br>"
    else
    html += "<div class='div_product_detail product_detail_more div_product_detail_"+stt+"'><div style='border-top: 2px solid #ff0000;'></div><br>"
    ...
    html+='        <div class="form-group">';
    html+='            <select name="colorProduct" id="colorProduct-'+stt+'" class="form-control colorProduct">';
    ...
    html+='          </div>';
    html+='         <img style="width: 100px; margin-top:10px;" class="img-product-demo" src="'+image+'" id="img-product-detail_'+stt+'" alt="">';
    html+='         <br>';
    ...
    html+='              <input name="original_cost_product" id="original_cost-'+stt+'" type="number" class="form-control" value='+original_cost+' >';
    html+='             </div>';
    html+='           </div>';
    html+='            <div class="col-sm-6">';
    html+='               <!-- text input -->';
    ...
    html+='                 <input name="discount_product" type="number" id="discount_product='+stt+'" class="form-control" value='+discount+'>';
    html+='               </div>';
    html+='             </div>';               
    html+='         </div>';
    html+='        <div><label for="usr">Amount</label>';
    html+='            <input type="number" name="amout_product" value='+amount+'  id="amout_product='+stt+'" class="form-control">';
...
function displayAddForm(stt,arrayColor,id_product){
    ...
    html+='              <input name="image_detail" type="file" id="image_detail_id_'+stt+'" image_detail='+stt+' class="form-control img_detail">';
    html+='          </div>';
    html+='         <img style="width: 100px; margin-top:10px;" src="/Admin/Image/no-image.jpg" class="img-product-demo" id="img-product-detail_'+stt+'" alt="">';
    html+='         <br>';
    html+='<small  id="image_detail-error-'+stt+'" class="text-danger image_detail-error"></small>';
    html+='         <br>';
    html+='         <div class="row">';
    ...
    html+='            <div class="form-group">';
    html+='              <label>Original Cost</label>';
    html+='              <input name="original_cost_product" id="original_cost-'+stt+'" type="number" class="form-control" value=0 >';
    html+='             </div>';
    html+='           </div>';
    html+='            <div class="col-sm-6">';
    html+='               <!-- text input -->';
    html+='               <div class="form-group">';
    html+='                 <label>Discount</label>';
    html+='                 <input name="discount_product" type="number" id="discount_product='+stt+'" class="form-control" value=0 >';
    html+='               </div>';
    html+='             </div>';               
    html+='         </div>';
    html+='        <div><label for="usr">Amount</label>';
    html+='            <input type="number" name="amout_product" value=0  id="amout_product='+stt+'" class="form-control">';
    html+='           <small class="text-danger"></small>';
    html+='        </div> ';
    html+='        <br>';
    html+='    </div>';
